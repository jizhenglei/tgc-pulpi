...
#include "../../include_a/archi/pulp_defs.h"

#if PULP_CHIP == CHIP_GAP
#include "chips/gap/config.h"
#elif PULP_CHIP == CHIP_VEGA
#include "chips/vega/config.h"
#elif PULP_CHIP == CHIP_GAP9
#include "chips/gap9/config.h"
#endif
...
// #include "include_a/archi/pulp.h"
