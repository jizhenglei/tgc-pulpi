...
, NAMED(router,  platfrom_mmap.size() + 3, 1)
...
, qspi2(*qspi2_ptr)
{
    ...
    router.initiator.at(++i)(spi_m.socket);
    router.set_target_range(i, 0x1A102100, 0x28);

    // router.initiator.at(++i)(spi_m.socket);
    // router.set_target_range(i, 0x1a102000, 0x2000); 
